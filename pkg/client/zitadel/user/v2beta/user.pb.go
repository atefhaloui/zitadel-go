...
type User struct {
	...
	UserId             string          `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	Details            *v2beta.Details `protobuf:"bytes,8,opt,name=details,proto3" json:"details,omitempty"`
	State              UserState       `protobuf:"varint,2,opt,name=state,proto3,enum=zitadel.user.v2beta.UserState" json:"state,omitempty"`
	Username           string          `protobuf:"bytes,3,opt,name=username,proto3" json:"username,omitempty"`
	LoginNames         []string        `protobuf:"bytes,4,rep,name=login_names,json=loginNames,proto3" json:"login_names,omitempty"`
	PreferredLoginName string          `protobuf:"bytes,5,opt,name=preferred_login_name,json=preferredLoginName,proto3" json:"preferred_login_name,omitempty"`
...
func (x *User) GetDetails() *v2beta.Details {
	if x != nil {
		return x.Details
	}
	return nil
...
var file_zitadel_user_v2beta_user_proto_rawDesc = []byte{
	...
	0x92, 0x41, 0x10, 0x4a, 0x08, 0x22, 0x4d, 0x69, 0x6e, 0x6e, 0x69, 0x65, 0x22, 0x78, 0xc8, 0x01,
	...
	0x42, 0x1f, 0x92, 0x41, 0x0f, 0x4a, 0x07, 0x22, 0x4d, 0x6f, 0x75, 0x73, 0x65, 0x22, 0x78, 0xc8,
	...
	0x42, 0x16, 0x92, 0x41, 0x0b, 0x4a, 0x06, 0x22, 0x4d, 0x69, 0x6e, 0x69, 0x22, 0x78, 0xc8, 0x01,
	0xfa, 0x42, 0x05, 0x72, 0x03, 0x18, 0xc8, 0x01, 0x48, 0x00, 0x52, 0x08, 0x6e, 0x69, 0x63, 0x6b,
	0x4e, 0x61, 0x6d, 0x65, 0x88, 0x01, 0x01, 0x12, 0x46, 0x0a, 0x0c, 0x64, 0x69, 0x73, 0x70, 0x6c,
	0x61, 0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x1e, 0x92,
	0x41, 0x13, 0x4a, 0x0e, 0x22, 0x4d, 0x69, 0x6e, 0x6e, 0x69, 0x65, 0x20, 0x4d, 0x6f, 0x75, 0x73,
	0x65, 0x22, 0x78, 0xc8, 0x01, 0xfa, 0x42, 0x05, 0x72, 0x03, 0x18, 0xc8, 0x01, 0x48, 0x01, 0x52,
	...
	0x67, 0x75, 0x61, 0x67, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x42, 0x12, 0x92, 0x41, 0x08,
	0x4a, 0x04, 0x22, 0x65, 0x6e, 0x22, 0x78, 0x0a, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x18, 0x0a, 0x48,
	...
	0x12, 0x32, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x20, 0x92,
	0x41, 0x10, 0x4a, 0x08, 0x22, 0x6d, 0x79, 0x2d, 0x6b, 0x65, 0x79, 0x22, 0x78, 0xc8, 0x01, 0x80,
	...
	0x01, 0x28, 0x0c, 0x42, 0x5d, 0x92, 0x41, 0x4c, 0x32, 0x23, 0x54, 0x68, 0x65, 0x20, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x20, 0x68, 0x61, 0x73, 0x20, 0x74, 0x6f, 0x20, 0x62, 0x65, 0x20, 0x62, 0x61,
	0x73, 0x65, 0x36, 0x34, 0x20, 0x65, 0x6e, 0x63, 0x6f, 0x64, 0x65, 0x64, 0x2e, 0x4a, 0x1e, 0x22,
	0x56, 0x47, 0x68, 0x70, 0x63, 0x79, 0x42, 0x70, 0x63, 0x79, 0x42, 0x74, 0x65, 0x53, 0x42, 0x30,
	0x5a, 0x58, 0x4e, 0x30, 0x49, 0x48, 0x5a, 0x68, 0x62, 0x48, 0x56, 0x6c, 0x22, 0x78, 0xa0, 0xc2,
	0x1e, 0x80, 0x01, 0x01, 0xe0, 0x41, 0x02, 0xfa, 0x42, 0x08, 0x7a, 0x06, 0x10, 0x01, 0x18, 0xa0,
	0xc2, 0x1e, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xa6, 0x05, 0x0a, 0x09, 0x48, 0x75,
	...
	0x65, 0x64, 0x22, 0xfb, 0x04, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x44, 0x0a, 0x07, 0x75,
	...
	0x64, 0x12, 0x38, 0x0a, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x18, 0x08, 0x20, 0x01,
	...
	0x6c, 0x73, 0x52, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x54, 0x0a, 0x05, 0x73,
	...
	,
	...
	,
	...
	0x6b, 0x65, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x2a, 0x58, 0x0a, 0x06, 0x47, 0x65, 0x6e, 0x64, 0x65,
	...
	0x03, 0x2a, 0x4a, 0x0a, 0x0f, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	0x54, 0x79, 0x70, 0x65, 0x12, 0x1c, 0x0a, 0x18, 0x41, 0x43, 0x43, 0x45, 0x53, 0x53, 0x5f, 0x54,
	0x4f, 0x4b, 0x45, 0x4e, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x42, 0x45, 0x41, 0x52, 0x45, 0x52,
	0x10, 0x00, 0x12, 0x19, 0x0a, 0x15, 0x41, 0x43, 0x43, 0x45, 0x53, 0x53, 0x5f, 0x54, 0x4f, 0x4b,
	0x45, 0x4e, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4a, 0x57, 0x54, 0x10, 0x01, 0x2a, 0x9e, 0x01,
	...
	0x43, 0x4b, 0x45, 0x44, 0x10, 0x04, 0x12, 0x16, 0x0a, 0x12, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x53,
	0x54, 0x41, 0x54, 0x45, 0x5f, 0x49, 0x4e, 0x49, 0x54, 0x49, 0x41, 0x4c, 0x10, 0x05, 0x42, 0x36,
...
var file_zitadel_user_v2beta_user_proto_goTypes = []interface{}{
	...
	(*v2beta.Details)(nil),        // 12: zitadel.object.v2beta.Details
}
var file_zitadel_user_v2beta_user_proto_depIdxs = []int32{
	...
	12, // 7: zitadel.user.v2beta.User.details:type_name -> zitadel.object.v2beta.Details
	2,  // 8: zitadel.user.v2beta.User.state:type_name -> zitadel.user.v2beta.UserState
	6,  // 9: zitadel.user.v2beta.User.human:type_name -> zitadel.user.v2beta.HumanUser
	8,  // 10: zitadel.user.v2beta.User.machine:type_name -> zitadel.user.v2beta.MachineUser
	1,  // 11: zitadel.user.v2beta.MachineUser.access_token_type:type_name -> zitadel.user.v2beta.AccessTokenType
